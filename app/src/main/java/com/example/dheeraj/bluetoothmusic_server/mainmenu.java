package com.example.dheeraj.bluetoothmusic_server;
...
import com.example.dheeraj.bluetoothmusic_server.Adapters.PairedDevicesAdapter;
import com.example.dheeraj.bluetoothmusic_server.Adapters.SongListAdapters;
import com.example.dheeraj.bluetoothmusic_server.models.Song;
...
public class mainmenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvphone.setText(bluetoothAdapter.getName()+" is acting as the server....");
...
*/
        ...
        PairedDevicesAdapter adapter=new PairedDevicesAdapter(mainmenu.this,pairedDevices);
    ...
    public void listScannedDevices(){
        ...
        PairedDevicesAdapter adapter=new PairedDevicesAdapter(mainmenu.this,scannedDevices);
    ...
    public void client_btn(View view) {
...
//            Toast.makeText(mainmenu.this,"Run1",Toast.LENGTH_SHORT).show();
    ...
    private class ConnectThread extends Thread {
      ...
      //      Toast.makeText(mainmenu.this,"Run2",Toast.LENGTH_SHORT).show();
        ...
        //    Toast.makeText(mainmenu.this,"Client: the connection is done a separate thread.",Toast.LENGTH_LONG).show();
